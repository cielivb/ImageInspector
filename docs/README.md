...
![](https://img.shields.io/github/languages/top/cielivb/ImageViewer?logo=python&logocolor=ff00ff&logosize=auto&color=yellow)
![](https://img.shields.io/github/license/cielivb/ImageViewer?color=yellow)
<!-- badges: end -->

# WxPython-Image-Viewer-Panel
ImageViewer is a WxPython-compatible widget with the ability to zoom and pan across an image in a similar manner to using Google Maps.
